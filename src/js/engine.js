...
function generate_moveEntitiesAtIndex(OBJECT_SIZE, MOVEMENT_SIZE) {
	...
	let movementMask=globalThis._movementVecs[globalThis._movementVecIndex];
	globalThis._movementVecIndex = (globalThis._movementVecIndex + 1) % globalThis._movementVecs.length;
...
// polyfill variables for globalThis
// use globalThis to access global variables in dynamic function, 
...
if (globalThis.getLayersOfMask === undefined)
